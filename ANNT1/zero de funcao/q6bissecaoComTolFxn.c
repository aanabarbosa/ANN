...
int main(){
    double a = 0.086869;  // intervalo dado ou chutado para fazer o teorema de bolzano               
    double b =   1.299713;// e descobrir se aqui tem ou nao uma raiz
    int n = 64;  // ordem de parada por interaçoes. nesse caso 10 iteraçoes
    double tol =  2.15308e-08; //ordem de prada pela tolerancia
...
double f(double x){
        return 3.14159265358979323846*x-exp(x);
