...
double f(double x){
        return ((9.81*x)/28.15)*(1-exp(-(28.15/x)*8.15))-33.66;
...
int main() {
    //bissecao
    printf("\n/////////////////////////////bissecao/////////////////////////////\n");
    double a =  26.9;  // intervalo dado ou chutado para fazer o teorema de bolzano               
    double b =   202.14;// e descobrir se aqui tem ou nao uma raiz
    ...
    //secante
    printf("\n/////////////////////////////secante/////////////////////////////\n");
   double x_ini = 21.46; //primeiro ponto chutado
   double x_dois = 38.95; //segundo ponto chutado
   ...
   secante(f, x_ini,x_dois, o);
    ...
    //posfalsa
    printf("\n/////////////////////////////posicao falsa/////////////////////////////\n");
    double comeco_intervalo = 22.22;  // primeiro ponto chutado
    double final_intervalo = 202.94;  // segundo ponto chutado
