...
int main() {
    double a =
        0.50109;  // intervalo dado ou chutado para fazer o teorema de bolzano
    double b = 2.03731;  // e descobrir se aqui tem ou nao uma raiz
    int vet[20] = {
       2, 4, 5, 6, 11, 12, 13, 16, 21, 22, 23, 24, 28, 29, 31, 33, 35, 36, 37, 38  };  // ordem de parada por interaçoes.                                        
    double tol =
