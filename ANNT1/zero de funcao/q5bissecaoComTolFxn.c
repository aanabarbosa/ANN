...
int main(){
    double a = -1.511844;  // intervalo dado ou chutado para fazer o teorema de bolzano               
    double b =   1.457399;// e descobrir se aqui tem ou nao uma raiz
    int n = 64;  // ordem de parada por interaçoes. nesse caso 10 iteraçoes
    double tol =  2.14869e-08; //ordem de prada pela tolerancia
