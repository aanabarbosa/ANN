//x^2−4.6806x+1.4504=0
// para aexata usei o symbolab e prestei atençao em qual intervalo deveria estar essa exata, pois são duas raizes
#include <math.h>
#include <stdio.h>
...
double f(double x) {
    return x*x-4.6806*x+1.4504;  // aqui vai a funçao na qual se busca encontrar as raizes
};
