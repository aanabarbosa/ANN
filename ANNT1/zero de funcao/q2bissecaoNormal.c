...
int main(){
    double a = 0.41436;  // intervalo dado ou chutado para fazer o teorema de bolzano               
    double b =  1.29693;// e descobrir se aqui tem ou nao uma raiz
    int n = 18;  // ordem de parada por interaçoes. nesse caso 10 iteraçoes
