...
int main(){
    double a = 0.903372;  // intervalo dado ou chutado para fazer o teorema de bolzano               
    double b = 1.950773;// e descobrir se aqui tem ou nao uma raiz
    int n = 64;  // ordem de parada por interaçoes. nesse caso 10 iteraçoes
    double tol =  2.01431e-12; //ordem de prada pela tolerancia
