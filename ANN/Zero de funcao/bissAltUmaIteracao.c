...
int main(){
    double a = 0;  // intervalo dado ou chutado para fazer o teorema de bolzano               
    double b =  16.02;// e descobrir se aqui tem ou nao uma raiz
    int n = 50;  // ordem de parada por interaçoes. nesse caso 10 iteraçoes
...
// int main(){
//     double a = 36.75;  // intervalo dado ou chutado para fazer o teorema de bolzano               
//     double b =  198.44;// e descobrir se aqui tem ou nao uma raiz
//     int n = 50;  // ordem de parada por interaçoes. nesse caso 10 iteraçoes
//     double tol =  0.0000000000000000001; //ordem de prada pela tolerancia
//     bissection(f, a, b, n, tol);
// }
...
// }
// double f(double x){
//         return ((9.81*x)/22.87)*(1-exp(-(22.87/x)*8.89)) - 31.77 ;  // aqui vai a funçao na qual se busca encontrar as raizes
//     };
